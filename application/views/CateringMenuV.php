      ...
      @media only screen and (max-width: 300px) {
        ...
        <body>
			...
			<form action='MenuC' method='post' align = 'center' style = 'color: #003366;'>
					<label style = 'font-style: oblique;'><h1>Number of Event Attendees</h1>        </label>
					<input type = 'text' name = 'Event Attendees'  style = 'font-style: oblique;background-color: #003366; color: white; text-align: center; padding: 5px 5px; border: none; height: 30px; width: 70px; border-radius: 5px;'>
			</form>
