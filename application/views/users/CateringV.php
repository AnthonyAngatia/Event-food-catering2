...
<body>
            ...
            <div class="form-group">
                ...
                <div class="food-types-wrapper">
                    <div class="food_types">
                        <h3>Carbohydrates</h3>
                        <input type="checkbox" name="Carbohydrates[]" value="100" id="carb1" />
                        Rice<br />
                        <input type="checkbox" name="Carbohydrates[]" value="200" id="carb2" />
                        Potatoes<br />
                        <input type="checkbox" name="Carbohydrates[]" value="100" id="carb3" />
                        Ugali<br />
                        <input type="checkbox" name="Carbohydrates[]" value="150" id="carb4" />
                        Spaghetti<br />
                        <input type="checkbox" name="Carbohydrates[]" value="110" id="carb5" />
                        Chips<br />
                    </div>

                    <div class="food_types">
                        <h3>Proteins</h3>
                        <input type="checkbox" name="Proteins[]" value="100" id="prot1" />
                        Beef<br />
                        <input type="checkbox" name="Proteins[]" value="150" id="prot2" />
                        Pork<br />
                        <input type="checkbox" name="Proteins[]" value="700" id="prot3" />
                        Chicken<br />
                        <input type="checkbox" name="Proteins[]" value="450" id="prot4" />
                        Fish<br />
                        <input type="checkbox" name="Proteins[]" value="250" id="prot5" />
                        Meat Ball<br />
                    </div>

                    <div class="food_types">
                        <h3>Salad</h3>
                        <input type="checkbox" name="Salads[]" value="100" id="salad1" />
                        Drinks<br />
                        <input type="checkbox" name="Salads[]" value="200" id="salad2" />
                        Proteins<br />
                        <input type="checkbox" name="Salads[]" value="100" id="salad3" />
                        Salads<br />
                        <input type="checkbox" name="Salads[]" value="200" id="salad4" />
                        Veg<br />
                        <input type="checkbox" name="Salads[]" value="200" id="salad5" />
                        Veg<br />l0
                    </div>
                    <div class="food_types">
                        <h3>Drinks</h3>
                        <input type="checkbox" name="Drinks[]" value="100" id="drink1" />
                        Drinks<br />
                        <input type="checkbox" name="Drinks[]" value="200" id="drink2" />
                        Proteins<br />
                        <input type="checkbox" name="Drinks[]" value="100" id="drink3" />
                        Salads<br />
                        <input type="checkbox" name="Drinks[]" value="200" id="drink4" />
                        Cocktail<br />
                        <input type="checkbox" name="Drinks[]" value="200" id="drink5" />
                        Drink<br />
                    </div>
                </div>
    ...
    <script>
    //!For now you cannot miss to pick a food item
    function getCarbValue() {
        //TODO:One Carb
        var carb1 = document.getElementById('carb1');
        var carb1Value = '';
        if (carb1.checked) {
            carb1Value = parseInt(carb1.value);
        } else {
    ...
    function getProtValue() {
        ...
        var prot1Value = '';
        if (prot1.checked) {
            prot1Value = parseInt(prot1.value);
        } else {
    ...
    function getSaladValue() {
        ...
        var saladValue = '';
        if (salad1.checked) {
            salad1Value = parseInt(salad1.value);
        } else {
    ...
    function getDrinkValue() {
        ...
        var drinkValue = '';
        if (drink1.checked) {
            drink1Value = parseInt(drink1.value);
        } else {
